<?php
global $js, $phasen_graph;

$phasen_graph=1;

$js .= '
	$("#phase1").addClass("active");
	$("#phase2").addClass("active");
...
$(document).ready(function() {
	...
	$(".phover").mouseenter(function() {
		$(".popup").addClass("hide");
		id=$(this).attr("data-ref");
		$("#pop"+id).removeClass("hide",1500);
		// $("#pop"+id).stop(true,true).removeClass("hide", 1500);
	}).mouseleave(function() {
	});
...
function setPhasen() {
	...
	bH = ($("#bua_phase").height() / 2)+plusH;

	var x = $("#pr1").position();  	
	if(wW>1200) var x = $("#pr1").position();  	

	$("#pr1t").css({"top":x.top+"px", "left": (x.left-minus)+"px"});  
	$("#pu1t").css({"top":(x.top+bH)+"px", "left": (x.left-minus)+"px"});  

	var x = $("#pr2").position();  	
	$("#pr2t").css({"top":x.top+"px", "left": (x.left-minus)+"px"});  
	$("#pu2t").css({"top":(x.top+bH)+"px", "left": (x.left-minus)+"px"});  

	var x = $("#pr3").position();  	
	$("#pr3t").css({"top":x.top+"px", "left": (x.left-minus)+"px"});  
	$("#pu3t").css({"top":(x.top+bH)+"px", "left": (x.left-minus)+"px"});  

	var x = $("#pr4").position();  	
	$("#pr4t").css({"top":x.top+"px", "left": (x.left-minus)+"px"});  
	$("#pu4t").css({"top":(x.top+bH)+"px", "left": (x.left-minus)+"px"});  

	var x = $("#pr5").position();  	
	$("#pr5t").css({"top":x.top+"px", "left": (x.left-minus)+"px"});  
	$("#pu5t").css({"top":(x.top+bH)+"px", "left": (x.left-minus)+"px"});  
}
';

$output .= '
<div id="die_phasen">
	<div id="pr1t" class="abs percent">100%</div>
	<div id="pr2t" class="abs percent">83%</div>
	<div id="pr3t" class="abs percent">0%</div>
	<div id="pr4t" class="abs percent">0%</div>
	<div id="pr5t" class="abs percent">0%</div>

	<div id="pu1t" class="abs subline" data-ref="1">PROZESS- START</div>
	<div id="pu2t" class="abs subline" data-ref="2">THEMEN- SPRINTS</div>
	<div id="pu3t" class="abs subline" data-ref="3">MARKT DER THEMEN</div>
	<div id="pu4t" class="abs subline" data-ref="4">MARKT DER PARTNER- SCHAFTEN</div>
	<div id="pu5t" class="abs subline" data-ref="5">AUFBRUCH DER PARTNER-SCHAFTEN</div>

<?xml version="1.0" encoding="utf-8"?>
<svg version="1.1" id="bua_phase" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 1112.6 288.3" style="enable-background:new 0 0 1112.6 288.3;" xml:space="preserve">
<g id="phase5" class="phover hover5" data-ref="5">
...
<g id="phase4" class="phover hover4" data-ref="4">
...
<g id="phase3" class="phover hover3" data-ref="3">
...
<g id="phase2" class="phover hover2" data-ref="2">
	...
	<g id="phase2a" class="phover hover1">
...
<g id="phase1" class="phover hover1" data-ref="1">
...
<div id="pop1" class="popup">
	<div class="row">
		<div class="col-12 col-md-6 col-lg-4 offset-lg-2 text-center">
			<p class="dot dot1">Prozessstart</p>
			<p><strong>Ziel:</strong> </p>
			<p><strong>Format:</strong> </p>	
		</div>
		<div class="col-12 col-md-6 col-lg-4 text-center liste">
			<p class="dot1"><strong>TERMINE PHASE 1</strong></p>
		</div>
	</div>
</div>
...
<div id="pop2" class="popup">
	<div class="row">
		<div class="col-12 col-md-6 col-lg-4 offset-lg-2 text-center">
			<p class="dot dot2">THEMENSPRINTS</p>
			<p><strong>Ziel:</strong> Argumentenliste für<br/>
			Zukunftsthemen pro Akteursgruppe</p>
			<p><strong>Format:</strong> pro Akteursgruppe eine
			halbtägige Themenwerkstatt</p>	
		</div>
		<div class="col-12 col-md-6 col-lg-4 text-center liste">
			<p class="dot2"><strong>TERMINE PHASE 2</strong></p>
			<p><b>10. Juni 2022</b>: Wissenschaft</p>
			<p><b>14. Juni 2022</b>: Kunst und Kultur</p>
			<p><b>16. Juni 2022</b>: organisierte Zivilgesellschaft</p>
			<p><b>27. Juni 2022</b>: Politik und Verwaltung</p>
			<p><b>29. Juni 2022</b>: Wirtschaft</p>
		</div>
	</div>
</div>
...
<div id="pop3" class="popup">
	<div class="row">
		<div class="col-12 col-md-6 col-lg-4 offset-lg-2 text-center">
			<p class="dot dot3">Markt der Themen</p>
			<p><strong>Ziel:</strong> </p>
			<p><strong>Format:</strong> </p>	
		</div>
		<div class="col-12 col-md-6 col-lg-4 text-center liste">
			<p class="dot3"><strong>TERMINE PHASE 3</strong></p>
		</div>
	</div>
</div>
...
<div id="pop4" class="popup">
	<div class="row">
		<div class="col-12 col-md-6 col-lg-4 offset-lg-2 text-center">
			<p class="dot dot4">Markt der Partnerschaften</p>
			<p><strong>Ziel:</strong> </p>
			<p><strong>Format:</strong> </p>	
		</div>
		<div class="col-12 col-md-6 col-lg-4 text-center liste">
			<p class="dot4"><strong>TERMINE PHASE 4</strong></p>
		</div>
	</div>
</div>
...
<div id="pop5" class="popup">
	<div class="row">
		<div class="col-12 col-md-6 col-lg-4 offset-lg-2 text-center">
			<p class="dot dot5">Aufbruch der Partnerschaften</p>
			<p><strong>Ziel:</strong> </p>
			<p><strong>Format:</strong> </p>	
		</div>
		<div class="col-12 col-md-6 col-lg-4 text-center liste">
			<p class="dot5"><strong>TERMINE PHASE 5</strong></p>
		</div>
	</div>
</div>
