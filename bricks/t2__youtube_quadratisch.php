...
if(!$ytCt) $ytCt=1;
    ...
    <!-- video -->
		...
		<div class="video_wrapper video_square" style="background-image: url( \'https://img.youtube.com/vi/'.trim($text).'/hqdefault.jpg\' );">
		  ...
		  <div class="video_layer"><iframe src="" border="0" data-scaling="true" data-format="16:16"></iframe></div>
		</div>
    <!-- end video -->';

    	// <div class="video-wrapper" id="yt'.$ytCt.'">
