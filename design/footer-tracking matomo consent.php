			...
			<table>
			 	<tr class="ul">
					...
					<div id="optout-form">
						...
						<p class="mt1"><span class="mobileOn">Dienste Dritter und Analyse-Cookie</span> und ähnliche Technologien würden wir gerne verwenden, um die Präferenzen unserer Besucher besser zu verstehen.</p>
					</div>	
					</td>
				</tr>			
			</table>			
