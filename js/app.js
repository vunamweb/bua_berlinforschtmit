...
function showWave() {
	...
	new SiriWave({
		style: "ios9",
		container: document.getElementById("display_wave"),
		autostart: true,
	});
}
...
function createDownloadLink(blob) {
	...
	//li.appendChild(document.createElement ('h6'))	//add text
	li.appendChild(link);
	//li.appendChild(document.createElement ("</span>"))	//add text

	//upload link
	var upload = document.createElement('a');
	upload.classList.add('submit');
	upload.href = "#";
	upload.innerHTML = "Aufnahme senden";
