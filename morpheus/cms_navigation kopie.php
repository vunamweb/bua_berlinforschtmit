...
-->
				...
				<?php if(in_array(60,$auths) || $admin) { ?>
					...
					<li class="panel panel-default <?php global $event_in; echo $event_in; ?>" id="dropdown">
						<a data-toggle="collapse" href="#dropdown-lvl16">
							<i class="fa fa-mortar-board "></i> Veranstaltungen/Events <span class="caret"></span>
						</a>
						<div id="dropdown-lvl16" class="panel-collapse collapse <?php global $event_in; echo $event_in; ?>">
							<div class="panel-body">
								<ul class="nav navbar-nav">
									<li<?php echo $event1_active; ?>><a href="morp_veranstaltung.php" title=""><i class="fa fa-calendar"></i> Veranstaltungen</a></li>
								</ul>
							</div>
						</div>
					</li>
				...
				<?php if(in_array(10,$auths) || $admin) { ?>
					...
					<li class="panel panel-default <?php global $newsletter_in; echo $newsletter_in; ?>" id="dropdown">
				...
				<?php	} ?>
				<?php if(in_array(40,$auths) || $admin) { ?>

					<li class="panel panel-default <?php global $config_in; echo $config_in; ?>">
					    ...
					    <div id="dropdown-lvl4" class="panel-collapse collapse <?php global $config_in; echo $config_in; ?>">
					        <div class="panel-body">
					            <ul class="nav navbar-nav">
									<li<?php echo $conf1_active; ?>><a href="sprachdatei.php"><i class="fa fa-bullhorn"></i> Text Templates</a></li>
									<li<?php echo $conf2_active; ?>><a href="morp_settings.php" title="settings kunden"><i class="fa fa-users "></i> Einstellungen Kunde</a></li>
									<li<?php echo $conf3_active; ?>><a href="morp_settings_css.php" title="settings css"><i class="fa fa-paint-brush "></i> Einstellungen CSS</a></li>
									<li<?php echo $conf4_active; ?>><a href="config_css.php?datei=../css/css.css" title="config morpheus"><i class="fa fa-users "></i> CSS stylesheet </a></li>
									<li<?php echo $conf5_active; ?>><a href="morp_settings_fonts.php" title="settings fonts"><i class="fa fa-tags "></i> Einstellungen Fonts</a></li>
									<li<?php echo $conf6_active; ?>><a href="morp_icons.php" class="nav" title="Icons konfigurieren"><i class="fa fa-star-half-o"></i> Icons konfigurieren</a></li>
									<li<?php echo $conf7_active; ?>><a href="morp_colors.php" class="nav" title="Icons konfigurieren"><i class="fa fa-eyedropper"></i> Farben konfigurieren</a></li>
					            </ul>
					        </div>
					    </div>
					</li>
				...
				<!--	<li><a href="sitemap_erstelle.php" title="index erstellen"><i class="fa fa-sort-alpha-asc"></i> Sitemap/Index erstellen</a></li>-->
					...
					<li class="panel panel-default <?php global $settings_in; echo $settings_in; ?>">
						<a data-toggle="collapse" href="#dropdown-lvl2">
							<i class="fa fa-rocket "></i> Admin <span class="caret"></span>
						</a>
						<div id="dropdown-lvl2" class="panel-collapse collapse <?php global $settings_in; echo $settings_in; ?>">
							<div class="panel-body">
								<ul class="nav navbar-nav">
									<li<?php echo $set1_active; ?>><a href="user.php" title="backup morpheus"><i class="fa fa-users "></i> Userverwaltung</a></li>
									<!-- <li><a href="user_intranet.php" title="backup morpheus"><i class="fa fa-users "></i> User Register</a></li> -->
									<li<?php echo $set2_active; ?>><a href="config.php?datei=../nogo/config.php" title="config morpheus"><i class="fa fa-users "></i> Config Editor</a></li>
								</ul>
							</div>
						</div>
					</li>
