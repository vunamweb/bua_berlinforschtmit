...
elseif ($copy) {
	...
	$sql	= "INSERT `morp_cms_content` set navid=$edit, tpos=$y, theadl='$th', content='$de', tid='$tid', vid='$vID', tlink='$tlink', tbackground='$tb', timage='$timage', theight='$theight', twidth='$twidth', tref='$tref', tclass='$tclass', tabstand='$tabstand', klasse='$klasse', tabstand_bottom='$tabstand_bottom'";
	$res	= safe_query($sql);
