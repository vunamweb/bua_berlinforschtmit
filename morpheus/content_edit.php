...
elseif ($save) {
	...
	if ($db != "morp_cms_news" && $db != "productkat") 	
		$set = "SET ".$cont."='$text', edit=1, layout='$layout' ";
	else
		$set = "SET ".$cont."='$text', edit=1 ";
...
<table bgcolor=\"$bgcolor\" id=\"t".$counter."\" class=\"item\">
	<tr>";
		...
		<td class="c150" valign="top"> &nbsp; '.$counter.'.  
		<a href="javascript:check(\'brick_change.php?cid='.$edit.'&navid='.$navid.'&back='.$back.'&pos='.$counter.'&db='.$db.'\');" class="textedit">' .str_replace("_", " ", $b_chk) .'</a></td>
		<td></td>
			'.$textbox_abschluss.'
		<td>	
