...
if ($navid || $kurs || $vorlage) $incl_lnk = "image_liste.php?box=$box&live_edit=$live_edit&stelle=$stelle&navid=$navid&edit=$edit&cedit=$cedit&vorlage=$vorlage";
...
#		image_liste.php?inr=2&cid=$edit&gid=4&back=$back
		...
		if ($inr) $lnk = "<a href=\"image_liste.php?box=$box&gid=$id&inr=$inr&cid=$cid&back=$back&vorlage=$vorlage\" name=\"$id\">";
		elseif ($incl_lnk) $lnk = "<a href=\"" .$incl_lnk ."&gid=$id&back=$back&db=$db&imglnk=$imglnk&art=$art\" name=\"$id\">";
		elseif ($nid) $lnk = "<a href=\"image_liste.php?box=$box&gid=$id&nid=$nid&ngid=$ngid\" name=\"$id\">";
		elseif ($newsletter) $lnk = "<a href=\"image_liste.php?box=$box&gid=$id&newsletter=$newsletter\" name=\"$id\">";
		elseif ($kurs) $lnk = "<a href=\"image_liste.php?box=$box&gid=$id&kurs=1\" name=\"$id\">ccccc";
		else $lnk = "<a href=\"image_liste.php?box=$box&gid=$id\" title=\"images verwalten, uploaden l&ouml;schen\">";
