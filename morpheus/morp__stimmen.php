...
';
	...
	<div class="zeile item row"  id="'.$row->$tid.'">
			...
			<div class="col-md-6">
				<a href="?ebene='.($ebene+1).'&parent='.$edit.'"><i class="fa fa-level-down"></i> &nbsp; '.$row->$anz.' </a>
				&nbsp; &nbsp; 
...
function edit($edit) {
	global $arr_form, $table, $tid, $imgFolder, $imgFolderShort, $um_wen_gehts, $ebene, $parent;
		...
		$echo .= '
			<div class="col-md-1 mb2">
				<div class="pretty p-default">
					<input type="checkbox" name="media[]" value="'.$row->mediaID.'"'.(in_array($row->mediaID, $medias) ? ' checked' : '').' />
					<div class="state p-info">
						<label>'.$row->mediaID.'</label>
					</div>
				</div>
			</div>';
	}
