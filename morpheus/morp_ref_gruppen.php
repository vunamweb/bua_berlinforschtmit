...
///////////////////////////////////////////////////////////////////////////////////////
//// EDIT_SKRIPT
$um_wen_gehts 	= "Signiton Gruppe";
$titel			= "Signition Gruppe";
///////////////////////////////////////////////////////////////////////////////////////
$table 	= "morp_ref_gruppe";
$tid 	= "gID";
$nameField 	= "gName";
$sortField 	= 'gName';

$imgFolder = "../images/cars/";
$imgFolderShort = "cars/";
///////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
//$sql = "ALTER TABLE  $table ADD  `detailID_en` INT( 11 ) NOT NULL";
//safe_query($sql);
/////////////////////////////////////////////////////////////////////////////////////////////////////

$arr_form = array(
//	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("gName", "Gruppe", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("targetID", "Gruppen ID", '<input type="Text" value="#v#" class="form-control" name="#n#"  />'),
	array("targetID_en", "Gruupen ID English", '<input type="Text" value="#v#" class="form-control" name="#n#"  />'),
	array("detailID", "Ziel ID", '<input type="Text" value="#v#" class="form-control" name="#n#"  />'),
	array("detailID_en", "Ziel ID English", '<input type="Text" value="#v#" class="form-control" name="#n#"  />'),
#	array("car_img", "Foto", 'fotoG', 'image', 'imgname', 6, 'gid'),
...
function liste() {
	global $arr_form, $table, $tid, $filter, $nameField, $sortField, $imgFolderShort, $hID;
