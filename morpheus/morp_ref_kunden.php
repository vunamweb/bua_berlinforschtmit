...
///////////////////////////////////////////////////////////////////////////////////////
//// EDIT_SKRIPT
$um_wen_gehts 	= "Signiton Kunden";
$titel			= "Signition Kunden";
///////////////////////////////////////////////////////////////////////////////////////
$table 	= "morp_ref_kunden";
$tid 	= "kID";
$nameField 	= "kName";
$sortField 	= 'kName';
...
$imgFolder = "../images/kunde/";
$imgFolderShort = "kunde/";
///////////////////////////////////////////////////////////////////////////////////////
...
$arr_form = array(
	array("kName", "Kunde", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
...
';
	...
	////////////////////
	$where = " 1 ";
	$sql = "SELECT * FROM $table WHERE $where ORDER BY gID, reihenfolge";
	$res = safe_query($sql);
