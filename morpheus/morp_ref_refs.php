...
///////////////////////////////////////////////////////////////////////////////////////
//// EDIT_SKRIPT
$um_wen_gehts 	= "Signiton Referenzen";
$titel			= "Signition Referenzen";
///////////////////////////////////////////////////////////////////////////////////////
...
$sortField 	= 'rName';
 ...
 $table2 	= "morp_ref_kunden";
 $tid2 		= "kID";
 $nameField2 = "kName";

$imgFolder = "../images/ref/";
$imgFolderShort = "ref/";
///////////////////////////////////////////////////////////////////////////////////////
...
//	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("rName", "Kampagnen Name", '<input type="Text" value="#v#" class="form-control" name="#n#" required onchange="setchange(\'1\');" />'),
	array("kID", "Kunde", 'sel2', $table2, $nameField2, $tid2),
	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
  	array("sichtbar", "sichtbar", 'chk'),
	array("aufgabe", "Aufgabe", '<textarea class="form-control" name="#n#"  onchange="setchange(\'1\');" />#v#</textarea>'),
	array("umsetzung", "Umsetzung", '<textarea class="form-control" name="#n#"  onchange="setchange(\'1\');" />#v#</textarea>'),
	array("ergebnis", "Ergebnis", '<textarea class="form-control" name="#n#"  onchange="setchange(\'1\');" />#v#</textarea>'),
	array("profit", "Profit Text", '<textarea class="form-control" name="#n#"  onchange="setchange(\'1\');" />#v#</textarea>'),

		array("", "CONFIG", '</div><div class="col-md-4"><h3 class="mb4">English</h3>'),

	array("rName_en", "Kampagnen Name English", '<input type="Text" value="#v#" class="form-control" name="#n#"  onchange="setchange(\'1\');" />'),
	array("aufgabe_en", "Aufgabe English", '<textarea class="form-control" name="#n#"  onchange="setchange(\'1\');" />#v#</textarea>'),
	array("umsetzung_en", "Umsetzung English", '<textarea class="form-control" name="#n#"  onchange="setchange(\'1\');" />#v#</textarea>'),
	array("ergebnis_en", "Ergebnis English", '<textarea class="form-control" name="#n#"   onchange="setchange(\'1\');"/>#v#</textarea>'),
	array("profit_en", "Profit English", '<textarea class="form-control" name="#n#"  onchange="setchange(\'1\');" />#v#</textarea>'),

		array("", "CONFIG", '</div><div class="col-md-2">'),

	array("img", "Banner", 'fotoG', 'image', 'imgname', 6, 'gid'),
	array("img1", "Image Referenz 1", 'foto'),
	array("img2", "Image Referenz 2", 'foto'),
	array("img3", "Image Referenz 3", 'foto'),

		array("", "CONFIG", '</div><div class="col-md-2">'),

	array("video", "Video Banner", 'img'),
	array("video1", "Video Referenz 1", 'img'),
	array("video2", "Video Referenz 2", 'img'),
	array("video3", "Video Referenz 3", 'img'),
...
';
	...
	////////////////////
	$where = " 1 ";
	$sql = "SELECT * FROM $table WHERE $where ORDER BY kID, reihenfolge ASC";
	$res = safe_query($sql);
	...
	<div class="zeile row'.( $hID = $row->hID ? ' haendler_edit' : '').'"  id="'.$row->$tid.'">
			...
			<div class="col-md-1">
				'.$edit_link.$row->reihenfolge.'
			</div>
			<div class="col-md-2">
				'.$edit_link.$row->$anz.'
			</div>			<div class="col-md-2">
				'.$edit_link.$row->rName_en.'
			</div>
			<div class="col-md-2">
				'.$row->targetID.'
			</div>
