...
///////////////////////////////////////////////////////////////////////////////////////
//// EDIT_SKRIPT
$um_wen_gehts 	= "Signiton Team";
$titel			= "Signition Team";
///////////////////////////////////////////////////////////////////////////////////////
$table 	= "morp_team";
$tid 	= "tID";
$nameField 	= "tname";
...
$arr_form = array(
	array("tname", "Name", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("tposition", "Position", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("tmail", "E-Mail", '<input type="Text" value="#v#" class="form-control" name="#n#"  />'),
	array("ttext_de", "Text Deutsch", '<textarea class="form-control" name="#n#" />#v#</textarea>'),
	array("ttext_en", "Text English", '<textarea class="form-control" name="#n#" />#v#</textarea>'),
	array("img", "Foto", 'fotoG', 'image', 'imgname', 6, 'gid'),
	array("video", "Video", 'fotoG', 'image', 'imgname', 6, 'gid'),
...
function liste() {
	global $arr_form, $table, $tid, $filter, $nameField, $sortField, $imgFolderShort, $hID, $imgFolder;
...
';
	...
	<div class="zeile row'.( $hID = $row->hID ? ' haendler_edit' : '').'"  id="'.$row->$tid.'">
			...
			<div class="col-md-1">
				'.($row->img ? '<img src="mthumb.php?h=40&amp;src='.$imgFolder.$row->img.'">' : '' ).'
			</div>
			<div class="col-md-1">
				'.($row->video ? 'video' : '').'
			</div>
