...
/* * * *  BRAND auslesen um richtigen EDITOR zu laden * * * * * */
$brand = 1; // getBrand($liste);
if($brand == 1) include("editor.php");
else include("editor-lr.php");
#$logo = $brand == 1 ? '1-jag' : '1-lr';
...
///////////////////////////////////////////////////////////////////////////////////////
 ...
 $vorschau = '<p><br/><a href="../preview.php?nlid='.$liste.'" rel="gb_page_center[340]" target="_blank"><i class="fa fa-tablet large"></i></a> &nbsp; <a href="../preview.php?nlid='.$liste.'" rel="gb_page_center[640]" target="_blank"><i class="fa fa-desktop large"></i></a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="../testmail.php?nlid='.$liste.'" rel="gb_page_center[340]" target="_blank"  title="send mail"><i class="fa fa-send "></i></a></p>';
...
function setArray($db, $edit) {
	...
	if($rw->texte3) $arr_form[] = array("text3", "Unformatierter Text // Bildbeschreibung", '<input type="Text" value="#v#" class=" unloadmsg" name="#n#" style="#s#">');
	if($rw->texte) $arr_form[] = array("text", "Text", '<textarea class="tiny unloadmsg" name="#n#" style="#s# width:100% !important;">#v#</textarea>', 'text');
	if($rw->textweb) $arr_form[] = array("textweb", "Web Text", '<textarea class="tiny unloadmsg" name="#n#" style="#s# ; width:100% !important;">#v#</textarea>', 'text');
...
<!--			<td ><p><a href="?edit='.$edit.'&liste='.$liste.'">'.strip_tags(substr($row->$anz2,0,170)).'</a></p></td>
		...
		elseif ($arr[3] == "text") {
			$echo .= '<tr>
				<td colspan="2">Ein manueller Link sollte die folgende Struktur haben, um vom Tracking erfasst zu werden:<br/>
					Beispiel: <br>https://www.julianhopp.de/aphorismen/thema/ueber-identitaet-%E2%80%A2+12/#blog<br/>
						<span style="color:red">https://www.julianhopp.de/jh.php?uid=#uid#&nl=#nlid#&il=</span><b>https://www.julianhopp.de/aphorismen/thema/ueber-identitaet-%E2%80%A2+12/#blog</b>
					'. str_replace(
