...
<div class="slider_2">
	...
	while ($row = mysqli_fetch_object($result)) {
        ...
        <a class="play_audio playme play1" href="'.$dir.''.$url_media.'">
          ...
          <img src="'.$dir.'images/play_audio.png"/>
        </a>
                                                ...
                                                '.($rubrik ? '<input type="hidden" name="rubrik" id="rubrik" value="'.$rubrik.'">' : '').'
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <!-- <p><a href="#" class="btn btn_audio"><img src="https://bua.morpheus-cms.de/berlinforschtmit/stimmen/images/SVG/i_btn_audio.svg" alt="" class="img-fluid" width="150"> <span>0.12</span></a></p> -->
                                                        </div>
